...
{
    /* Source Image info */
    char *src_image_fname; //storing the name of the .bmp file
    FILE *fptr_src_image;
    uint image_capacity;
    uint bits_per_pixel;
    ...
    /* Stego Image Info */
    char *stego_image_fname; //storing output file name
...
/*Encode 4 bytes into LSB of image data array*/
